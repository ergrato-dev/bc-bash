...
# Las funciones se definen con nombre() { }
# Se llaman solo con el nombre (sin paréntesis)
...
# Puedes definir varias funciones y llamarlas en orden
# Descomenta las siguientes líneas:
...
# }
# 
# # Esto funciona porque está definida arriba
# funcion_definida_primero
# 
# # Esto causaría error (comentado para evitar error):
# # funcion_no_definida  # Error: command not found
...
# Buena práctica: documentar funciones con comentarios
# Descomenta las siguientes líneas:
